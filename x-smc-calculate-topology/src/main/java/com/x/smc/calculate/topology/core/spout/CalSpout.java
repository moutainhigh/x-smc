package com.x.smc.calculate.topology.core.spout;
...
import com.x.smc.calculate.topology.core.bo.FinishListVo;
...
//                .getCacheClient(SmcCacheConstant.NameSpace.STATS_TIMES);
        String finishlist = RedisUtil.getCacheClient().hget(SmcCacheConstant.NameSpace.STATS_TIMES,
        ...
        RedisUtil.getCacheClient().hdel(SmcCacheConstant.NameSpace.STATS_TIMES,
                SmcCacheConstant.Cache.finishKey);
        for (FinishListVo vo : voList) {
            ...
            RedisUtil.getCacheClient().hset(SmcCacheConstant.Cache.lockKey, batchNo, vo.getStats_times());
            try {
