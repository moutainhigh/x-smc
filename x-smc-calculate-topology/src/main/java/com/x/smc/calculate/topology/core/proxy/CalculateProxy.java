package com.x.smc.calculate.topology.core.proxy;
...
import com.x.storm.jdbc.JdbcTemplate;
...
import com.x.smc.calculate.topology.constants.SmcExceptCodeConstant;
import com.x.smc.calculate.topology.core.bo.StlBillData;
import com.x.smc.calculate.topology.core.bo.StlBillItemData;
import com.x.smc.calculate.topology.core.bo.StlElement;
import com.x.smc.calculate.topology.core.bo.StlPolicy;
import com.x.smc.calculate.topology.core.bo.StlPolicyItem;
import com.x.smc.calculate.topology.core.bo.StlPolicyItemCondition;
import com.x.smc.calculate.topology.core.bo.StlPolicyItemPlan;
import com.x.smc.calculate.topology.core.bo.StlSysParam;
import com.x.smc.calculate.topology.core.bo.SwitchCalValue;
import com.x.smc.calculate.topology.core.util.DateUtil;
import com.x.smc.calculate.topology.core.util.IKin;
import com.x.smc.calculate.topology.core.util.RedisUtil;
import com.x.smc.calculate.topology.core.util.SftpUtil;
import com.x.smc.calculate.topology.core.util.SmcCacheConstant;
import com.x.smc.calculate.topology.core.util.SmcCacheConstant.ParamCode;
import com.x.smc.calculate.topology.core.util.SmcCacheConstant.TypeCode;
//import com.x.smc.calculate.topology.core.util.SmcCacheFactory;
import com.x.smc.calculate.topology.core.util.SmcConstants;
import com.x.smc.calculate.topology.core.util.SmcSeqUtil;
//import com.x.storm.jdbc.JdbcProxy;
//import com.x.storm.jdbc.JdbcTemplate;
//import com.x.storm.sequence.datasource.SeqDataSourceLoader;
//import com.x.storm.sequence.util.SeqUtil;
...
//                .getCacheClient(SmcCacheConstant.NameSpace.BILL_CACHE);
        ...
        String billAll = RedisUtil.getCacheClient().hget(billKey, policyId);
        ...
        if (StringUtils.isBlank(billAll)) {
            ...
            RedisUtil.getCacheClient().hset(billKey, policyId, JSON.toJSONString(stlBillData));
        } else {
            stlBillData = JSON.parseObject(billAll, StlBillData.class);
        }
        RedisUtil.getCacheClient().hincrByFloat(assembleCacheKey(SmcCacheConstant.Cache.BILL_DATA_PREFIX, bsn),
                policyId, value);
        ...
        String billItemData = RedisUtil.getCacheClient().hget(billItemKey, policyIdAndFeeItemKey);
        ...
        if (StringUtils.isBlank(billItemData)) {
            ...
            RedisUtil.getCacheClient().hset(billItemKey, policyIdAndFeeItemKey, JSON.toJSONString(stlBillItemData));
        }
        RedisUtil.getCacheClient().hincrByFloat(
