package com.x.smc.preprocess.topology.core.constant;
...
public final class SmcConstants {
    ...
    public static final String STATS_TIMES_KEY = "stats_times";
    
    public static final String BILL_DETAIL_HBASE_FAMILY_NAME = "bill_col_def";
    public static final String BILL_DETAIL_HBASE_TABLE_NAME_PREFIX = "BILL_DETAIL_DATA_";
    ...
    public static final class  PlanType{
	 	public static final String NORMAL = "normal";//标准型
	 	public static final String STEP = "step";//阶梯
	 	public static final String SWITCH = "switch";//分档
	 	public static final String COUNT = "count";//统计
	 	
	 	private PlanType() {}
    }
    
    public static final class  CalType{
	 	public static final String FIXED = "fixed";//固定值
	 	public static final String EXP = "exp";//表达式
